...
Promise.all([(0, _propertyList.getPropertyList)(), (0, _propertyList.getSaleTypeList)(), (0, _propertyList.getProvinceList)()]).then(function (_ref) {
  ...
  (0, _propertyList3.setOptions)(_propertyList4.minPriceOptions, 'select-min-price', 'Precio min');
  (0, _propertyList3.setOptions)(_propertyList4.maxPriceOptions, 'select-max-price', 'Precio max');
});

var loadPropertyList = function loadPropertyList(propertyList) {
  var viewModelPropertyList = (0, _propertyList2.mapPropertyListApiToVm)(propertyList);
